...
public sealed class ComponentTest : TestContext
{
    ...
    public ComponentTest(ITestOutputHelper testOutputHelper)
    {
        ...
        _cut = RenderComponent<AudioConverterComponent>();
    }
